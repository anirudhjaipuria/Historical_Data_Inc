...
if __name__ == '__main__':
    for SYMBOL in SYMBOLS:
        ...
        #   Paths
        # ────────────────────────────────────────────────
        csv_file_path = rf'C:\PYTHON\historical_data\CRYPTO\{SYMBOL}\{SYMBOL}_2hour_candlesticks_all.csv'
        output_dir    = rf'C:\PYTHON\historical_data\CRYPTO\{SYMBOL}\output_2hour_parquet'
